...
- **Staff Stream Flow & Notation Contracts**:
  ...
  - Notehead styling for physical piano keys: white piano keys ($C, D, E, F, G, A, B$) feature a crisp white outline (`#ffffff`); black piano keys ($C\sharp, D\sharp, F\sharp, G\sharp, A\sharp$) feature a black outline (`#090d16`) AND a solid black centre dot indicator for immediate, unambiguous recognition.
